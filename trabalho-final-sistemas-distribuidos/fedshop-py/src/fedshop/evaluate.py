    ...
    *,
    ...
    if batch_id > 0:
        ...
        if check_timeout_propagation(prev_results):
            ...
            _persist_evaluation_artifacts(
                config, bench_dir, engine_name, query_name, instance_id,
                batch_id, attempt, stats_path, results_csv, provenance_csv,
                source_sel_txt, query_plan_txt,
            )
            return stats_path
...
def _persist_evaluation_artifacts(
    ...
    try:
        ...
        run_id = store.persist_execution_from_files(
            ...
            provenance_path=provenance_csv,
            source_selection_path=source_sel_txt,
            query_plan_path=query_plan_txt,
        )
