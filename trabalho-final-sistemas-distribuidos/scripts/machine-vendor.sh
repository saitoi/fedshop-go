#!/usr/bin/env bash
# machine-vendor.sh — Máquina B: Virtuoso que serve os grafos vendor*.
#
...
# por endpoint, então esta máquina recebe o mesmo dataset que a máquina C.
#
# Uso:
#   bash scripts/machine-vendor.sh [--config PATH]
set -euo pipefail
...
echo "══ Máquina VENDOR: subindo Virtuoso ══"
...
echo
echo "Na máquina A, aponte FEDSHOP_VENDOR_ENDPOINT=http://${IP:-IP_DESTA_MAQUINA}:8890/sparql"
